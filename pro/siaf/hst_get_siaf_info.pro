;+
; FUNCTION: hst_get_siaf_info
;
; PURPOSE: Read HST/COS SIAF information from fits files.
;
; Description: Not used for JWST analysis, but retained for purposes of comparison
;
;+function hst_get_siaf_info,pid,rootname,shdr=shdr,verbose=verbose
	if n_elements(verbose) ne 1 then verbose=0
		spid=string1i(pid)
		rcs_id="$Id$"
		if verbose then message,/info,'Gathering HST/COS SIAF information on PID = '+spid+' : '+rootname
