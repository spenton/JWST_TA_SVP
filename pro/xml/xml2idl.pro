;+
; PRO: XML2IDL, oNode,level=level,nodeName=nodeName,nodeValue=nodeValue,struct=struct,paramArr=paramArr
;
; PURPOSE: Read .xml file into an IDL structure (used for JWST SIAF files
;
;-
